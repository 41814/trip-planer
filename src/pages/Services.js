  ...
  const services = [
    {
      ...
      imageUrl: "airline4.jpg", // Replace with actual image path
    },
    {
      title: "Best Flight Rates",
      price: "PKR 25,994",
      description: "Travel Your Dream Destination.",
      imageUrl: "airline2.jpg", // Replace with actual image path
    },
    {
      title: "Affordable Umrah",
      price: "PKR 25,499",
      description: "Umrah Service For Everyone.",
      imageUrl: "airlinee.jpg", // Replace with actual image path
    },
    {
      title: "Luxury Transport",
      price: "PKR 30,000",
      description: "Experience Comfort and Style.",
      imageUrl: "visa.webp", // Replace with actual image path
    },
    {
      title: "Cheap Flights",
      price: "PKR 22,500",
      description: "Get the Best Deals.",
      imageUrl: "img4.webp", // Replace with actual image path
    },
    {
      title: "Umrah Packages",
      price: "PKR 40,000",
      description: "Hassle-Free Umrah Experience.",
      imageUrl: "traveldeals.webp", // Replace with actual image path
    },
  ];

  // Create groups of three services for the carousel
