...
const Muree = () => {
  const images = [
    { src: 'ka.jpg', alt: 'Lahore - Badshahi Mosque' },
    { src: 'isl.jpg', alt: 'Destination 2' },
    { src: 'background.jpg', alt: 'Destination 3' },
    { src: 'oo.jpeg', alt: 'Destination 4' },
    { src: 'mor4.jpg', alt: 'Destination 5' },
  ];
    ...
    <>
      <header className="header5">
        <div className="header-background5">
          <img src="muree.jpg" alt="Pakistan Landscape" />
        </div>
