...
const   Karachi = () => {
  const images = [
    { src: 'ka1.jpg', alt: 'Lahore - Badshahi Mosque' },
    { src: 'ka2.jpg', alt: 'Destination 2' },
    { src: 'ka3.jpg', alt: 'Destination 3' },
    { src: 'ka5.jpg', alt: 'Destination 4' },
    { src: 'ka6.jpg', alt: 'Destination 5' },
  ];

  const [selectedImage, setSelectedImage] = useState(images[0]);
<div className="header-background6">
    ...
    <>
      <header className="header3">
        <div className="header-background3">
          <img src="quaide.jpg" alt="Pakistan Landscape" />
        </div>
